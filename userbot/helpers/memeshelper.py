...
RRAID = [
    "KYA APKI MA AIDS KI BAJAH SE MARI YE BAAT SACH HAI O.o",
    "KYA APKI MA MAR KE BHI CHUDWATI HAI :V",
    "KYA APKI MA MERE LUND SE KHUSS HO JATI HAI :V",
    "KYA APKI MA KI GAND KE BAAL CHUDNE KI BAJAH SE JHAD GYE :V",
    "KYA APKI MA CHOOT MAI LUND INJECTION KE JAISE LETI HAI :V",
    "KYA APKI MA VIRYA KO ANTIBAITIC TONIK SAMAJH KE PEETI HAI :V..",
    "KYA APKI MA MUH MAI LUND DALL KE CHUSNA PASAND KARTI HAI :V.",
    "GADWE KE LUND KE BAAL :V",
    "KYA APKI MA KO LUND SE CHUDNA JYADA HI PASAND HAI :P?",
    "TERI BEHAN KO NANGA KAR DU :3",
    "KYA AAP APNI MA KO CHOD KE PAIDA HUYE HAI :V",
    "KYA TUM DUNIYA KE SABSE PAHLE APNI MA KE DALAL HO :3",
    "teri MAA MERA LUND LETI H NA?",
    "TERII BHENN MAR GAYI CHUD CHUD KR",
    "KYA TERI MAA KI XHUT ABHI BHI JAWAN HAI?",
    "TERI MAA INSTA PRR REELS BNATI H NANGI HOKR",
    "TERI MA KI KALI XHUT ME LUNDD MARUU",
    "TERII MAA KAISE CHUD JATI H YE BATA?",
    "TERI MAA KAA BOXDA FATA PADA YE LAD RAHA YAHA",
    "TYPEE KRR AJA SPEED PAKAD",
    "AJA BAAP KI SPEED PAKAD ROO MAT",
    "ROO GAYA RANDI MAA KAA BACCCHA",
    "PAPA KI SPEED MATCH NHI HO RHI KYA",
    "ALEE AOLLE MERA BETA",
    "KAISA CHODA TERA PAPA NE",
    "ABB TU TERI BHEN KI CHUT LA CHAL",
    "HAA TOH?TERI MAA CHOD DU AISE?",
    "KALAP SAALA SUARR",
    "SUAR KEE BAXXHE NIBBE SAALE",
    "ABB BHAGA TOH TERI GAND ME MERE LUND KE BAAL KA DHAGA",
    "TU LEGA REE PAPA SE PANGA TERI BHEN KI XHUT",
    "HAA TERII MAA KI XHUT ME LETA HU ROZ",
    "SHARAM KRR SUARR KEE BAXXHE",
    "TERI MAA MAR GAYI OR TU HAS RAHA SAALE",
    "GANDU KEE BAXXHEEE SAALE",
    "SHRM KR",
    "SUARR KI JHAAT KAA BAAAL🤣",
    "TERA KHANDAAN KHATAAM KRR DUNGA AJJ",
    "RANDI KE BETE",
    "KIDXX SUARR SAALEE RANDI KEE BAXXHE",
    "TERI MAA KA EK OR BAXXHA PAIDA HO JAYEGA AISE KREGA TOH",
    "TERI MAA KAA LODA H JO TERA BAAP LETA",
    "TERII MAA KO CHUDWA JAKRR RANDI KEE BAXXHE",
    "TERII BHENN RANDII SAALEE SUARR KEE BAXXHEE",
    "TERII MAA BHEN KI LODDIII",
    "TERII MAA KI XHUT ME MERA MUUT DAL DUNGAA RANDII KEE BAXXHE",
    "BETE TERI MA SBSE BADI RAND",
    "GUU KHANE WALA SUAR PAPA SE LADEGAA",
    "TERII MAA BHAUT BADI RAND H RANDI KEE BAXXHE",
    "KASH OS DIN MUTH MRKE SOJTA M TUN PAIDA NA HOTAA",
    "GLTI KRDI TUJW PAIDA KRKE",
    "SPEED PKDDD RAND KI PAIDSISH",
    "TERI MAA KI XHUT ME MERA LUND DAL OR SOJA",
    "TERI BHEN MERI RAKHEL H RANDI KEE BAXXHE",
    "GAND FTI KE BALKKK",
    "Gote kitne bhi bade ho, lund ke niche hi rehte hai",
    "TERI MA KI CHUT ME LUND MARA THA ISILIYYE TU YAHA HAI",
    "Jhaant ke pissu-",
    ...
    "TERII MAA XHOD DI JAYEGI SAMJHAA LAWDE",
    ...
    "TERII BHENN RANDIIII HAIIII RANIDIII",
    "SUARR KEE BAXXHEE TERII BEHN KI XHUT",
    "TERII BHEN XHDUUU",
    "RANDII KEE BAXXHEE",
    "RANDI KE PILLE",
