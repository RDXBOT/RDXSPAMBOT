...
LOGS.info("RDX SPAM BOT IS WORKING.!!!")
LOGS.info(
    "Congratulation, now type .ping to see message if bot is live\
    \nIf you need assistance, head to https://t.me/RDX_SPAM_BOT"
)


async def startupmessage():
    await bot(functions.channels.JoinChannelRequest(channel="@RDX_SPAM_BOT"))
    try:
